...
7 >Emitted(7, 27) Source(1, 28) + SourceIndex(1)
8 >Emitted(7, 28) Source(1, 29) + SourceIndex(1)
9 >Emitted(7, 31) Source(1, 32) + SourceIndex(1)
10>Emitted(7, 32) Source(1, 33) + SourceIndex(1)
11>Emitted(7, 41) Source(1, 34) + SourceIndex(1)
12>Emitted(7, 42) Source(1, 35) + SourceIndex(1)
13>Emitted(7, 43) Source(1, 36) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
----------------------------------------------------------------------
prepend: (0-543):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (0-543)
///<reference path="./tripleRef.d.ts"/>
var file0Const = new libfile0();
