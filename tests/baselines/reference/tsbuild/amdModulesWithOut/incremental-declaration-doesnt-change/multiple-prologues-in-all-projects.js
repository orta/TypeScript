...
7 >Emitted(9, 27) Source(1, 28) + SourceIndex(3)
8 >Emitted(9, 28) Source(1, 29) + SourceIndex(3)
9 >Emitted(9, 31) Source(1, 32) + SourceIndex(3)
10>Emitted(9, 32) Source(1, 33) + SourceIndex(3)
11>Emitted(9, 41) Source(1, 34) + SourceIndex(3)
12>Emitted(9, 42) Source(1, 35) + SourceIndex(3)
13>Emitted(9, 43) Source(1, 36) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
"myPrologue2";
----------------------------------------------------------------------
prepend: (62-553):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (62-553)
var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
...
7 >Emitted(8, 27) Source(1, 28) + SourceIndex(2)
8 >Emitted(8, 28) Source(1, 29) + SourceIndex(2)
9 >Emitted(8, 31) Source(1, 32) + SourceIndex(2)
10>Emitted(8, 32) Source(1, 33) + SourceIndex(2)
11>Emitted(8, 41) Source(1, 34) + SourceIndex(2)
12>Emitted(8, 42) Source(1, 35) + SourceIndex(2)
13>Emitted(8, 43) Source(1, 36) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/lib/module.js
sourceFile:file2.ts
