...
7 >                         )
8 >                          ;
1 >Emitted(86, 5) Source(26, 51) + SourceIndex(1)
2 >Emitted(86, 12) Source(26, 58) + SourceIndex(1)
3 >Emitted(86, 13) Source(26, 59) + SourceIndex(1)
4 >Emitted(86, 16) Source(26, 62) + SourceIndex(1)
5 >Emitted(86, 17) Source(26, 63) + SourceIndex(1)
6 >Emitted(86, 26) Source(26, 64) + SourceIndex(1)
7 >Emitted(86, 27) Source(26, 65) + SourceIndex(1)
8 >Emitted(86, 28) Source(26, 66) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
5 >                20
6 >                  ;
1 >Emitted(91, 5) Source(1, 14) + SourceIndex(2)
2 >Emitted(91, 13) Source(1, 14) + SourceIndex(2)
3 >Emitted(91, 14) Source(1, 15) + SourceIndex(2)
4 >Emitted(91, 17) Source(1, 18) + SourceIndex(2)
5 >Emitted(91, 19) Source(1, 20) + SourceIndex(2)
6 >Emitted(91, 20) Source(1, 21) + SourceIndex(2)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
...
5 >                  10
6 >                    ;
1 >Emitted(93, 1) Source(1, 1) + SourceIndex(3)
2 >Emitted(93, 5) Source(1, 7) + SourceIndex(3)
3 >Emitted(93, 16) Source(1, 18) + SourceIndex(3)
4 >Emitted(93, 19) Source(1, 21) + SourceIndex(3)
5 >Emitted(93, 21) Source(1, 23) + SourceIndex(3)
6 >Emitted(93, 22) Source(1, 24) + SourceIndex(3)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:file3.ts
...
5 >                30
6 >                  ;
1->Emitted(97, 5) Source(1, 14) + SourceIndex(4)
2 >Emitted(97, 13) Source(1, 14) + SourceIndex(4)
3 >Emitted(97, 14) Source(1, 15) + SourceIndex(4)
4 >Emitted(97, 17) Source(1, 18) + SourceIndex(4)
5 >Emitted(97, 19) Source(1, 20) + SourceIndex(4)
6 >Emitted(97, 20) Source(1, 21) + SourceIndex(4)
---
-------------------------------------------------------------------
emittedFile:/src/app/module.js
sourceFile:file4.ts
...
2 >Emitted(99, 5) Source(1, 7) + SourceIndex(5)
3 >Emitted(99, 10) Source(1, 12) + SourceIndex(5)
4 >Emitted(99, 13) Source(1, 15) + SourceIndex(5)
5 >Emitted(99, 15) Source(1, 17) + SourceIndex(5)
6 >Emitted(99, 16) Source(1, 18) + SourceIndex(5)
---
>>>//# sourceMappingURL=module.js.map
...
----------------------------------------------------------------------
prepend: (0-4231):: ../lib/module.js texts:: 1
>>--------------------------------------------------------------------
text: (0-4231)
/*@internal*/ /*@internal*/ var myGlob = 20;
define("file1", ["require", "exports"], function (require, exports) {
