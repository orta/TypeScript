...
2 >Emitted(5, 5) Source(7, 7) + SourceIndex(0)
3 >Emitted(5, 6) Source(7, 8) + SourceIndex(0)
4 >Emitted(5, 9) Source(7, 11) + SourceIndex(0)
5 >Emitted(5, 23) Source(7, 25) + SourceIndex(0)
6 >Emitted(5, 24) Source(7, 26) + SourceIndex(0)
---
>>>
>>>
>>>console.log(s);
...
2 >Emitted(7, 5) Source(7, 7) + SourceIndex(0)
3 >Emitted(7, 6) Source(7, 8) + SourceIndex(0)
4 >Emitted(7, 9) Source(7, 11) + SourceIndex(0)
5 >Emitted(7, 23) Source(7, 25) + SourceIndex(0)
6 >Emitted(7, 24) Source(7, 26) + SourceIndex(0)
---
>>>
>>>
>>>console.log(s);
...
"myPrologue3";
----------------------------------------------------------------------
prepend: (78-194):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (78-194)
...
----------------------------------------------------------------------
prepend: (194-481):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (194-481)
var N;
(function (N) {
