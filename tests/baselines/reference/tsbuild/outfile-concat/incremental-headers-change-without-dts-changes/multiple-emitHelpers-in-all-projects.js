...
7 >             )
8 >              ;
1 >Emitted(25, 1) Source(11, 1) + SourceIndex(0)
2 >Emitted(25, 8) Source(11, 8) + SourceIndex(0)
3 >Emitted(25, 9) Source(11, 9) + SourceIndex(0)
4 >Emitted(25, 12) Source(11, 12) + SourceIndex(0)
5 >Emitted(25, 13) Source(11, 13) + SourceIndex(0)
6 >Emitted(25, 14) Source(11, 14) + SourceIndex(0)
7 >Emitted(25, 15) Source(11, 15) + SourceIndex(0)
8 >Emitted(25, 16) Source(11, 16) + SourceIndex(0)
---
>>>function forfirstfirst_PART1Rest() { }
1->
2 >^^^^^^^^^
...
4 >                                () { 
5 >                                     }
1->Emitted(26, 1) Source(12, 1) + SourceIndex(0)
2 >Emitted(26, 10) Source(12, 10) + SourceIndex(0)
3 >Emitted(26, 33) Source(12, 33) + SourceIndex(0)
4 >Emitted(26, 38) Source(12, 38) + SourceIndex(0)
5 >Emitted(26, 39) Source(12, 39) + SourceIndex(0)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
...
8 >               )
9 >                ;
1 >Emitted(27, 1) Source(1, 1) + SourceIndex(1)
2 >Emitted(27, 8) Source(1, 8) + SourceIndex(1)
3 >Emitted(27, 9) Source(1, 9) + SourceIndex(1)
4 >Emitted(27, 12) Source(1, 12) + SourceIndex(1)
5 >Emitted(27, 13) Source(1, 13) + SourceIndex(1)
6 >Emitted(27, 14) Source(1, 14) + SourceIndex(1)
7 >Emitted(27, 16) Source(1, 16) + SourceIndex(1)
8 >Emitted(27, 17) Source(1, 17) + SourceIndex(1)
9 >Emitted(27, 18) Source(1, 18) + SourceIndex(1)
---
-------------------------------------------------------------------
emittedFile:/src/first/bin/first-output.js
sourceFile:../first_part3.ts
...
2 >function 
3 >         f
1 >Emitted(28, 1) Source(1, 1) + SourceIndex(2)
2 >Emitted(28, 10) Source(1, 10) + SourceIndex(2)
3 >Emitted(28, 11) Source(1, 11) + SourceIndex(2)
---
>>>    return "JS does hoists";
1->^^^^
2 >    ^^^^^^^
...
3 >           "JS does hoists"
4 >                           ;
1->Emitted(29, 5) Source(2, 5) + SourceIndex(2)
2 >Emitted(29, 12) Source(2, 12) + SourceIndex(2)
3 >Emitted(29, 28) Source(2, 28) + SourceIndex(2)
4 >Emitted(29, 29) Source(2, 29) + SourceIndex(2)
---
>>>}
1 >
2 >^
...
2 >Emitted(30, 2) Source(3, 2) + SourceIndex(2)
---
>>>function firstfirst_part3Spread() {var b = [];
1->
2 >^^^^^^^^^
...
2 >Emitted(31, 10) Source(4, 10) + SourceIndex(2)
3 >Emitted(31, 32) Source(4, 32) + SourceIndex(2)
4 >Emitted(31, 36) Source(4, 33) + SourceIndex(2)
5 >Emitted(31, 47) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
5 >                                          
6 >                                            ...b: number[]
1->Emitted(32, 10) Source(4, 33) + SourceIndex(2)
2 >Emitted(32, 20) Source(4, 47) + SourceIndex(2)
3 >Emitted(32, 22) Source(4, 33) + SourceIndex(2)
4 >Emitted(32, 43) Source(4, 47) + SourceIndex(2)
5 >Emitted(32, 45) Source(4, 33) + SourceIndex(2)
6 >Emitted(32, 49) Source(4, 47) + SourceIndex(2)
---
>>>        b[_i] = arguments[_i];
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^^^^^^^^^
1 >
2 >        ...b: number[]
1 >Emitted(33, 9) Source(4, 33) + SourceIndex(2)
2 >Emitted(33, 31) Source(4, 47) + SourceIndex(2)
---
>>>    }
>>>}
1 >
...
1 >) { 
2 >}
1 >Emitted(35, 1) Source(4, 51) + SourceIndex(2)
2 >Emitted(35, 2) Source(4, 52) + SourceIndex(2)
---
>>>firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
1->
2 >^^^^^^^^^^^^^^^^^^^^^^
...
10>                                                         ]
11>                                                          );
1->Emitted(36, 1) Source(5, 1) + SourceIndex(2)
2 >Emitted(36, 23) Source(5, 23) + SourceIndex(2)
3 >Emitted(36, 47) Source(5, 27) + SourceIndex(2)
4 >Emitted(36, 48) Source(5, 28) + SourceIndex(2)
5 >Emitted(36, 50) Source(5, 30) + SourceIndex(2)
6 >Emitted(36, 52) Source(5, 32) + SourceIndex(2)
7 >Emitted(36, 54) Source(5, 34) + SourceIndex(2)
8 >Emitted(36, 56) Source(5, 36) + SourceIndex(2)
9 >Emitted(36, 58) Source(5, 38) + SourceIndex(2)
10>Emitted(36, 59) Source(5, 39) + SourceIndex(2)
11>Emitted(36, 62) Source(5, 41) + SourceIndex(2)
---
>>>//# sourceMappingURL=first-output.js.map
...
4 >Emitted(42, 36) Source(4, 33) + SourceIndex(2)
5 >Emitted(42, 47) Source(4, 47) + SourceIndex(2)
---
>>>    for (var _i = 0; _i < arguments.length; _i++) {
1->^^^^^^^^^
2 >         ^^^^^^^^^^
...
----------------------------------------------------------------------
prepend: (1180-1540):: ../../../first/bin/first-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1180-1540)
...
firstfirst_part3Spread.apply(void 0, __spread([10, 20, 30]));
----------------------------------------------------------------------
prepend: (1542-2156):: ../../../2/second-output.js texts:: 1
>>--------------------------------------------------------------------
text: (1542-2156)
var N;
(function (N) {
