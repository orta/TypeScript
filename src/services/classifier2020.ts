...
namespace ts.classifier.modern {
    ...
    export function getSemanticClassifications(program: Program, _cancellationToken: CancellationToken, sourceFile: SourceFile, span: TextSpan): ClassifiedSpan[] {
        ...
        Debug.assert(classifications.length % 3 === 0);
        const dense = classifications;
    ...
    class Context {
        ...
        private readonly scopeSymbolCacheStack: Map<string, Symbol | undefined>[];
        private scopeSymbolCache: Map<string, Symbol | undefined>;

        private readonly thisSymbolStack: (Symbol | undefined)[];
        private thisSymbol: Symbol | undefined;

        private readonly symbolToEncodedTokenType: Map<Symbol, number>;
        ...
        constructor(program: Program, sourceFile: SourceFile) {
            ...
            this.locals = [];
            this.scopeSymbolCacheStack = [new Map<string, Symbol | undefined>()];
            ...
            this.symbolToEncodedTokenType = new Map<Symbol, number>();
            this.result = [];
            this.resultLen = 0;
        }
